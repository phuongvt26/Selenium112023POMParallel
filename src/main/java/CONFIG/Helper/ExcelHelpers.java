...
public class ExcelHelpers {
    ...
    public void setExcelFile(String ExcelPath, String SheetName) {
        try {
            ...
            //adding all the column header names to the map 'columns' , luu từng dòng vào từng cột
    ...
    public String getCellData(int rowIndex, int colnumIndex) {
        try {
            cell = sh.getRow(rowIndex).getCell(colnumIndex);
    ...
    //Gọi ra hàm này nè
    public String getCellData(String columnName, int rowIndex) { //rowIndex: vị trí dòng
